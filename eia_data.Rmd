...
Finally for current data, the US EIA also produces a shale gas and light tight oil spreadsheet with data by play which is slightly different than the DPR data - it's more disaggregated. You can access the Excel spreadsheet directly [here](https://www.eia.gov/energyexplained/oil-and-petroleum-products/data/US-tight-oil-production.xlsx) for oil and [here](https://www.eia.gov/naturalgas/weekly/img/shale_gas_201907.xlsx) for gas. Again, the code link shows the means of downloading and processing the data via R. 
...
gas_prod_file<-"https://www.eia.gov/naturalgas/weekly/img/shale_gas_202201.xlsx"
